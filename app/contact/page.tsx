        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            ...
            <p className="mt-2 text-sm text-[#7A4A1A] max-w-2xl">
              We welcome in-person visits by appointment. Find us at our office
              location below.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#FFCE99]/40 sm:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <span className="text-xl">📍</span>
                  <div className="text-sm text-[#7A4A1A]">
                    <p className="font-semibold text-[#2F1500]">
                      Anandam Life Counseling Center
                    </p>
                    <p className="mt-1">
                      123 Wellness Street,
                      <br />
                ...
                <div className="pt-4 border-t border-[#FFCE99]/30">
                  <p className="text-xs font-semibold text-[#2F1500] mb-2">
                    Getting Here:
                  </p>
                  <ul className="space-y-1 text-xs text-[#7A4A1A]">
                    <li>• Nearest Metro: Wellness Station (5 min walk)</li>
            ...
            {/* Google Map */}
            <div className="rounded-3xl overflow-hidden shadow-sm ring-1 ring-[#FFCE99]/40">
              <div className="aspect-[4/3] w-full bg-gradient-to-br from-[#FF9644]/20 to-[#FFCE99]/30 flex items-center justify-center">
                <div className="text-center">
                  <p className="text-4xl mb-2">🗺️</p>
                  <p className="text-sm font-semibold text-[#2F1500]">
                    Google Map
                  </p>
                  <p className="text-xs text-[#7A4A1A] mt-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 inline-block rounded-full bg-white px-4 py-2 text-xs font-semibold text-[#AA5A00] hover:bg-[#FFF4E2] transition-colors"
                  >
                    Open in Google Maps →
                  </a>
                </div>
